...
output_file = '../output/results/english_results.csv'
c1 = 'TheDonald1'
c2 = 'TheDonald2'
c3 = 'HillaryC'
performance = True
...
name2results = {'BL_PPMI-between': f'../output/results/ppmi/{c1}_{c3}_CD.csv',
                ...
                'CR_BERT_PT-between': f'../output/results/bert-base-uncased-PT/{c1}_{c3}_APD.csv',
                'CR_BERT_PT-within': f'../output/results/bert-base-uncased-PT/{c1}_{c2}_APD.csv',
                'CR_BERT_FT-between': f'../output/results/bert-base-uncased-FT_RandomR/{c1}_{c3}_APD.csv',
                'CR_BERT_FT-within': f'../output/results/bert-base-uncased-FT_RandomR/{c1}_{c2}_APD.csv',
                ...
                'MP_BERT_PT-between': f'../output/results/bert-base-uncased-PT/{c1}_{c3}_JSD.csv',
                'MP_BERT_PT-within': f'../output/results/bert-base-uncased-PT/{c1}_{c2}_JSD.csv',
                'MP_BERT_FT-between': f'../output/results/bert-base-uncased-FT_RandomR/{c1}_{c3}_JSD.csv',
                'MP_BERT_FT-within': f'../output/results/bert-base-uncased-FT_RandomR/{c1}_{c2}_JSD.csv'}
